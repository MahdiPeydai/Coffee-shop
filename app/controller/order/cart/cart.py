...
from app.controller.middlewares.auth.login import user_login_check, user_login_require
...
def cart(user_id, cart_id):
    ...
    if cart_items_number == 0:
        cart_status = 'empty'
        return render_template('order/cart/cart.html', user_id=user_id, cart_items_number=cart_items_number,
