...
def user_information(user_id):
    ...
    return render_template('profile/information/information.html', user_information=user_information, user_id=user_id)
...
def user_information_edit(user_id):
    ...
    return render_template('profile/information/information_edit.html', form=form, user_id=user_id)
