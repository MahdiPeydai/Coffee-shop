...
from app.controller.middlewares.auth.login import user_login_require
...
def user_address(user_id):
    ...
    return render_template('profile/address/address.html', user_address=user_address, user_id=user_id)
...
def user_address_create(user_id):
    ...
    return render_template('profile/address/address_create.html', form=form, user_id=user_id)
...
def user_address_edit(user_id, address_id):
    ...
    return render_template('profile/address/address_edit.html', form=form, address_id=address_id)
